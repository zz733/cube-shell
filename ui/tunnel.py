...
class Ui_Tunnel(object):
    def setupUi(self, Tunnel):
        ...
        icon2 = QIcon()
        icon2.addFile(u":browser.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u":Settings-4.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(u":delete.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
